...
// Validate ../../src/app/api/supabase-clients/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/supabase-clients">> = Specific
  const handler = {} as typeof import("../../src/app/api/supabase-clients/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
